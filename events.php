                ...
                <section>
                    <div class="container">
                        ...
                        ?>
                            ...
                            <br><br>
                            <a class="btn btn-default" href="registerEvent.php?id=<?php echo $row['event_id']; ?>&price=<?php echo $row['event_price']; ?>"><span class="glyphicon glyphicon-circle-arrow-right"></span> Register for Event</a>
